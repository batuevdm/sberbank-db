...
<?php if( isset($query['do']) && $query['do'] == 'reg' ) {
  $reg = true;
} ?>

<div class="container <?php if($reg) { ?>hidden<?php } ?>">
  <div class="row">
    <h1>Открыть вклад</h1>
  </div>
</div>
<div class="container <?php if($reg) { ?>hidden<?php } ?>" id="q-form">
  <div class="row">
...
<div class="container <?php if(!$reg) { ?>hidden<?php } ?>" id="reg-form">
  <div class="row">
    <h3>Регистрация</h3>
    <div class="form-group">
